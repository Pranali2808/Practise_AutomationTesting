package com.bridgelabz.searchcontextinterface;
...
public class MethodsOfSearchContextInterface {
	@Test
	public static void methodsOfSearchContext() throws InterruptedException {
		System.setProperty("webdriver.gecko.driver", "C:\\Selenium\\geckodriver.exe");
		WebDriver driver = new FirefoxDriver();
		driver.get("https://www.facebook.com/");
		driver.findElement(By.name("email")).sendKeys("8446251018");
		Thread.sleep(3000);
